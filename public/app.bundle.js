...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = angular.module('app', ['ui.router', 'infinite-scroll', 'ng-goToTop', 'Arweil.mainCtrl', 'Arweil.homeCtrl', 'Arweil.workCtrl', 'Arweil.lifeCtrl']);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../../css-loader/0.23.1/css-loader/index.js!./../../../../../less-loader/2.2.3/less-loader/index.js!./bootstrap.css", function() {
				var newContent = require("!!./../../../../../css-loader/0.23.1/css-loader/index.js!./../../../../../less-loader/2.2.3/less-loader/index.js!./bootstrap.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./../../node_modules/.npminstall/less-loader/2.2.3/less-loader/index.js!./app.css", function() {
				var newContent = require("!!./../../node_modules/.npminstall/css-loader/0.23.1/css-loader/index.js!./../../node_modules/.npminstall/less-loader/2.2.3/less-loader/index.js!./app.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	mainCtrl.controller('mainCtrl', ['$scope', function ($scope) {
		...
		$scope.data_main = {
			navList: [{ 'name': 'Home', 'url': 'home' }, { 'name': 'Work', 'url': 'work' }, { 'name': 'Life', 'url': 'life' }]
		};
	}]);
...
/***/ function(module, exports) {
	...
	workCtrl.controller('workCtrl', ['$scope', function ($scope) {
		$scope.workBlogList = [{ title: 'The title of blog', img: '/public/img/tx.jpg', intro: '张建锋表示，“闲鱼”和“拍卖”都深具分享经济和强互动的社区基因，' + '二者联手后将共同探索包括闲鱼拍卖、闲鱼二手交易、闲鱼二手车在内的多种分享经济业务形态。', updateTime: '2016-05-19', tags: 'tag1 | tag2' }, { title: 'The title of blog', img: '/public/img/tx.jpg', intro: '张建锋表示，“闲鱼”和“拍卖”都深具分享经济和强互动的社区基因，' + '二者联手后将共同探索包括闲鱼拍卖、闲鱼二手交易、闲鱼二手车在内的多种分享经济业务形态。', updateTime: '2016-05-19', tags: 'tag1 | tag2' }, { title: 'The title of blog', img: '/public/img/tx.jpg', intro: '张建锋表示，“闲鱼”和“拍卖”都深具分享经济和强互动的社区基因，' + '二者联手后将共同探索包括闲鱼拍卖、闲鱼二手交易、闲鱼二手车在内的多种分享经济业务形态。', updateTime: '2016-05-19', tags: 'tag1 | tag2' }, { title: 'The title of blog', img: '/public/img/tx.jpg', intro: '张建锋表示，“闲鱼”和“拍卖”都深具分享经济和强互动的社区基因，' + '二者联手后将共同探索包括闲鱼拍卖、闲鱼二手交易、闲鱼二手车在内的多种分享经济业务形态。', updateTime: '2016-05-19', tags: 'tag1 | tag2' }, { title: 'The title of blog', img: '/public/img/tx.jpg', intro: '张建锋表示，“闲鱼”和“拍卖”都深具分享经济和强互动的社区基因，' + '二者联手后将共同探索包括闲鱼拍卖、闲鱼二手交易、闲鱼二手车在内的多种分享经济业务形态。', updateTime: '2016-05-19', tags: 'tag1 | tag2' }];

		$scope.moreData = function () {
			for (var i = 0, length = 5; i < length; i++) {
				$scope.workBlogList.push({ title: 'The title of blog', img: '/public/img/tx.jpg', intro: '张建锋表示，“闲鱼”和“拍卖”都深具分享经济和强互动的社区基因，' + '二者联手后将共同探索包括闲鱼拍卖、闲鱼二手交易、闲鱼二手车在内的多种分享经济业务形态。', updateTime: '2016-05-19', tags: 'tag1 | tag2' });
			}
		};
	}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	lifeCtrl.controller('lifeCtrl', ['$scope', function ($scope) {
		$scope.lifeBlogList = [{ title: 'This is a title', content: 'This is a content', img: '/public/img/tx.jpg' }, { title: 'This is a title', content: 'This is a content This is a content This is a content', img: '/public/img/test1.jpg' }, { title: 'This is a title', content: 'This is a content This is a content This is a content This is a content This is a content This is a content', img: '/public/img/tx.jpg' }, { title: 'This is a title', content: 'This is a content', img: '/public/img/tx.jpg' }, { title: 'This is a title', content: 'This is a content', img: '/public/img/tx.jpg' }, { title: 'This is a title', content: 'This is a content', img: '/public/img/test1.jpg' }, { title: 'This is a title', content: 'This is a content', img: '/public/img/tx.jpg' }, { title: 'This is a title', content: 'This is a content', img: '/public/img/test1.jpg' }, { title: 'This is a title', content: 'This is a content', img: '/public/img/tx.jpg' }];
	}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _imagesLoaded = __webpack_require__(27);
